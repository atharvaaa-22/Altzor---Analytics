...
export const SqlBlock = ({ code }: { code: string }): React.JSX.Element => {
    ...
    <div className="rounded-xl overflow-hidden my-4 border border-slate-700 bg-slate-900 shadow-xl">
      <div className="flex justify-between items-center bg-slate-800/80 px-4 py-2.5 border-b border-slate-700">
        ...
        <div className="flex gap-2">
          ...
          <button
            onClick={handleRun}
            className="flex items-center gap-1.5 bg-orange-500/20 text-orange-400 hover:bg-orange-500/40 px-3 py-1 rounded-md transition-colors text-xs font-medium border border-orange-500/20"
          >
